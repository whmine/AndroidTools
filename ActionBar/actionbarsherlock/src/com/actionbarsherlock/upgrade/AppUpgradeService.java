package com.actionbarsherlock.upgrade;
...
import com.actionbarsherlock.utils.DownloadUtils;
        ...
        public void handleMessage(Message msg) {
            ...
            case DOWNLOAD_SUCCESS:
                Toast.makeText(getApplicationContext(),
                        R.string.abs__app_upgrade_download_sucess,
                        Toast.LENGTH_LONG).show();
                install(destFile);
                break;
            case DOWNLOAD_FAIL:
                Toast.makeText(getApplicationContext(),
                        R.string.abs__app_upgrade_download_fail,
                        Toast.LENGTH_LONG).show();
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (Environment.getExternalStorageState().equals(
            ...
            destDir = new File(Environment.getExternalStorageDirectory()
                    .getPath() + BaseApplication.mDownloadPath);
            if (destDir.exists()) {
        ...
        mNotification.contentView = new RemoteViews(getApplication()
                .getPackageName(), R.layout.abs__app_upgrade_notification);
        ...
        mPendingIntent = PendingIntent.getActivity(AppUpgradeService.this,
                R.string.abs__app_name, completingIntent,
