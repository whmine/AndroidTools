...
package com.actionbarsherlock.whmine.book;
...
import com.actionbarsherlock.upgrade.AppUpgradeService;
...
public class MainActivity extends SherlockFragmentActivity implements
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        case R.id.menu_refresh:
            ...
            return true;
            /*
             * case R.id.menu_both: // rotation animation of green fragment
             * rotateLeftFrag(); return true; case R.id.menu_text: // alpha
             * animation of blue fragment ObjectAnimator alpha =
             * ObjectAnimator.ofFloat(rightFrag.getView(), "alpha", 1f, 0f);
             * alpha.setRepeatMode(ObjectAnimator.REVERSE);
             * alpha.setRepeatCount(1); alpha.setDuration(800); alpha.start();
             * return true; case R.id.menu_logo: useLogo = !useLogo;
             * item.setChecked(useLogo);
             * getSupportActionBar().setDisplayUseLogoEnabled(useLogo); return
             * true; case R.id.menu_up: showHomeUp = !showHomeUp;
